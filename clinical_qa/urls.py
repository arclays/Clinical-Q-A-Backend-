...
#     # Ds_answers endpoints
    ...
    path('Ds_questions/<int:pk>/click/', views.question_click, name='question-click'),
    ...
    path('Ds_questions/stats/by-disease/', views.disease_question_stats, name='disease-question-stats'),
